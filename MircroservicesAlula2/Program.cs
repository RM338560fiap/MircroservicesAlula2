...
namespace MircroservicesAlula2
{
    class Program
    {
        //const string QueueConnectionString = "Endpoint=sb://oliverfiap2.servicebus.windows.net/;SharedAccessKeyName=ProductPolicy;SharedAccessKey=5kWnKsC9MdqNIdXviT64nl5LLX5kjJdO3Xenle6NbEs";
        const string QueueConnectionString = "Endpoint=sb://oliverfiap.servicebus.windows.net/;SharedAccessKeyName=ProductPolicy;SharedAccessKey=xuva3qtFUfeUyJlNEW+DHAaibkSKbSJhOz2jM/ynCbQ";
        ...
        private static async Task SendMessagesAsync()
        {
            ...
            Task closeTask = _queueClient.CloseAsync();
            await closeTask;
            CheckCommunicationExceptions(closeTask);
